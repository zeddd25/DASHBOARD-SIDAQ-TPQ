...
const ModalCustom = ({ onClose }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center">
      ...
      <div className="mx-4 ring-1 ring-primary z-10 bg-white px-8 py-6 flex flex-col gap-4 rounded-lg shadow-md">
        ...
        <div>
          ...
          <div className="text-white flex justify-between gap-1">
            <button className="bg-gradient-to-r from-secondary to-primary px-12 py-2 rounded-full">Batal</button>
            <button className="bg-gradient-to-r from-secondary to-primary px-12 py-2 rounded-full">Update</button>
          </div>
      </div>
    </div>
  );
